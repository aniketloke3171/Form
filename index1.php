...
if(isset($_POST['name'])){
    ...
    $phone = $_POST['phone'];
    $desc = $_POST['desc'];
    $sql = "INSERT INTO `trip`.`us` (`name`, `age`, `gender`, `email`, `phone`, `other`, `dt`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$desc', current_timestamp());";
    // echo $sql;
...
<body>
    <img src="bg.jpg" class="bg" alt="NKOCET">
    <div class="container">
        <h1> Welcome To NKOCET Trip To Us</h1>
        <p> Please Fill Out Below Required Details To Get Chance To Fly To Us</p>
